...
Minigames and special scenes: prepared artwork covers the intro, seasonal boat journeys, Junimo Kart, darts scenery, crane game, fantasy board game, movies, cow photos, comet scene and selected arcade/mermaid regions. Nineteen dedicated variants and eleven translated cursor sheets preserve language-specific pixels. Existing artwork, titles, scoring geometry, controls, logos and technical masks remain protected. This is a bounded visual update; no minigame rules or rewards are changed.

Soil and floor patterns: normal, dark and snowy tilled-soil sheets retain their dry, watered and paddy banks, with restrained interior detail and exact tile connections. Remaining indoor pattern regions are completed across 88 legacy floors and the additional floor sheet, preserving all prior artwork and wallpaper. The legacy floor-pattern atlas is prepared separately; actual outdoor floor/path families continue using their native data-defined textures.

Polished Stardew artwork for NPCs, monsters, wildlife, interiors, outdoor locations, seasonal trees, crops, terrain and animated water, roads and bridges, all placeable path/fence families, craftable props and furniture. Version 0.22.0 contains 739 registered textures plus 17 separate player HD companions and eight body shade maps. Native frame positions and gameplay rules are preserved. This includes cosmetic runtime effects; full location-by-location gameplay has not been performed.

Tools, weapons and items: native tool tiers and poses, weapon icons, fishing bobbers, projectiles, debris and remaining shared item icons receive material detail. Six localized item sheets preserve their language-specific pixels. All 165 previously approved shared-sheet regions remain exact. Item IDs, stats, recipes and native animation geometry are unchanged. The mixed animation-effects atlas remains a separate scope.

Monsters and wildlife: all 73 monster sheets, including 20 dangerous variants, plus eight additional ambient creature sheets and Emily's parrot. Material detail preserves native dimensions, silhouettes, tint colors and animation layout. Existing island parrots remain covered by the previous artwork. Cat, Crow, Frog and Fireball sheets have unconfirmed live routes; their inclusion does not establish normal gameplay use. See docs/terrain-art/monsters-wildlife-progress.md in the project for validation and player checks.

Player detail: separate 2x body, hair, clothing, accessory and hat artwork keeps the native customization IDs, color tables and logical frame geometry. Body shading follows the game's selected skin, eye, sleeve and shoe colors. The character creator's magnify button (controller Y) opens an enlarged full-outfit preview with rotation; close it to resume the same creator. The animal-hat companion is included for future use; pet drawing is unchanged. Authored rendering and creator fixtures passed 103 checks; exhaustive animation and customization playtesting remains a player check.

Modern wardrobe: six new shirts and six new pants form the first modern clothing collection. Mix the pieces and dye them independently. New farmers can select them with the existing shirt and pants arrows in character creation; existing farmers can buy them from Sandy for 1,000g per piece when the desert is accessible. The collection adds denim layers, a hoodie, city layers, a pocket tee, a monochrome crewneck and utility casual pieces. Native body proportions and footwear remain separate. Stable item IDs and an authored catalog support future collections. Hidden fashion metadata is available to compatible Solace features; the art mod does not display a fashion score.

Cave atmosphere: 55 mining nodes, seven large rocks and cave plants gain material detail; selected ordinary mine, dark-mine and farm-cave stone surfaces use the approved slate palette. Ore colors, ladders, timber, functional tile IDs and unrelated item art stay intact. Ice and lava keep their existing palette. Small rock contact shadows and sparse water-edge glints, drips and ripples add depth. Native mine drip opportunities are localized to nearby water with a cooldown, preserving the existing ambient sound beds and music mute. Optional cave-atmosphere.json settings: Enabled (true), LocalizedDrips (true), Strength (0.18, capped at 0.35). Setting Enabled false restores native drip behavior and removes these cave effects. See the project mining progress report for native validation and limits.

Remaining farm structures: 17 utility and magical building sheets now have matching material detail, including the stable, silo, mill, well, fish pond, shipping bin, Slime Hutch, Junimo Hut, Gold Clock, four obelisks, mailbox and three pet bowls. Native seasonal states, water overlays, functional pieces and paint compatibility are preserved. See docs/terrain-art/utility-buildings-progress.md for validation and limits.

Animals and pets: 42 complete sprite sheets cover all livestock adult/baby/color states, sheared sheep, cats, dogs, turtles and the horse. Native alpha, frame geometry, breed colors and technical turtle cells are preserved. Two dormant cat/dog sheets are included without adding new selectable breeds. Existing artwork remains unchanged. See docs/terrain-art/animals-progress.md in the project for validation and limits.
